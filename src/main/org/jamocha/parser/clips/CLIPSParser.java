...
public class CLIPSParser implements CLIPSParserConstants {
  ...
  final public Object basicExpr() throws ParseException {Object exp = null;
  Token obj = null;
...
{if ("" != null) return ParserUtils.getStringLiteral(obj.image);}
      break;
      }
    case 0:{
      jj_consume_token(0);
...
// main expression for loading a data file
  final public List<Object> loadExpr() throws ParseException {ArrayList<Object> facts = new ArrayList<Object>();
    label_1:
    while (true) {
      loadAllExpr(facts);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return facts;}
    throw new Error("Missing return statement in function");
}

// this method is used to load data
  final public void loadAllExpr(List<Object> list) throws ParseException {ValueParam[] param = null;
    param = assertBody();
list.add(param);
}

  final public Object streamExpr() throws ParseException {ValueParam[] param = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACE:{
      param = assertBody();
...
// typeExpr is only responsible for parsing string and bigdecimal types
  final public Object typeExpr() throws ParseException {Token exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEGER_LITERAL:{
      exp = jj_consume_token(INTEGER_LITERAL);
// we use BigDecimal
    {if ("" != null) return new BigDecimal(exp.image);}
      break;
      }
    case STRING_LITERAL:{
...
{if ("" != null) return exp.image;}
  ...
  final public Object expr() throws ParseException {Token exp = null;
  Token exp2 = null;
  // Token exp3 = null;
  String body;
  // ValueParam param;
...
func = new ShellFunction();
  ...
  final public void valueParams(List<Object> list) throws ParseException {Object exp;
  Token tok;
  ValueParam vp = null;
 ...
 */
  final public void bindingParams(List<Object> list) throws ParseException {Object exp;
  Token tok;
  // ValueParam vp = null;
...
BoundParam bp = new BoundParam();
  ...
  final public Token getBindType() throws ParseException {Token exp;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case BIND3:{
 ...
 */
  final public String getIdentifier() throws ParseException {Token exp;
    exp = jj_consume_token(IDENTIFIER);
{if ("" != null) return exp.image;}
    throw new Error("Missing return statement in function");
}

  final public ValueParam[] assertBody() throws ParseException {Token exp;
...
/* assert body */
  final public void assertContents(List<Object> tokens) throws ParseException {Token exp;
  Object body = null;
    jj_consume_token(LBRACE);
    exp = jj_consume_token(IDENTIFIER);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (body != null) {
  ...
  final public Object checkMultiSlot() throws ParseException {Object body;
...
{if ("" != null) return artokens.toArray();}
...
{if ("" != null) return body;}
  ...
  final public Object slotValueType() throws ParseException {Object body;
  Token btoken;
  boolean boolval;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case BIND:
...
// probably should refactor this later, instead of looking up the value directly
    ...
    if (val != null) {
      {if ("" != null) return engine.getDefglobalValue(btoken.image);}
    } else {
      BoundParam bp = new BoundParam();
...
{if ("" != null) return body;}
    ...
    case FALSE2:{
      boolval = trueFalse();
{if ("" != null) return boolval;}
      break;
      }
    case IDENTIFIER:{
      btoken = jj_consume_token(IDENTIFIER);
{if ("" != null) return btoken.image;}
      break;
      }
    default:
      jj_la1[31] = jj_gen;
...
/* arrayType handles multislot tokens */
  final public void arrayType(List<Object> tokens) throws ParseException {Token tval;
  Object val;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
...
/* templateExpr gets the slots of a deftemplate */
  final public Deftemplate templateExpr() throws ParseException {Token exp;
  Deftemplate tmplate;
...
Slot[] s = new Slot[slots.size()];
    ...
    exp.clear();
    exp = null;
    {if ("" != null) return tmplate;}
    throw new Error("Missing return statement in function");
}

  final public void templateBody(List<Object> slots) throws ParseException {Token sname;
  int stype;
  int sid;
  Slot sl;
  MultiSlot msl;
...
sid = slots.size();
  ...
  final public int slotType() throws ParseException {int stype = -1;
  int defaultType = 9;
...
if (stype > -1) {
    ...
    {if ("" != null) return defaultType;}
    throw new Error("Missing return statement in function");
}

  final public Object defaultValue() throws ParseException {Object defobj = null;
...
{if ("" != null) return defobj;}
    throw new Error("Missing return statement in function");
}

  final public int getType() throws ParseException {Token exp = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEGER:{
      exp = jj_consume_token(INTEGER);
exp = null;
    {if ("" != null) return Constants.INT_PRIM_TYPE;}
      break;
      }
    case SHORT:{
      exp = jj_consume_token(SHORT);
exp = null;
    {if ("" != null) return Constants.SHORT_PRIM_TYPE;}
      break;
      }
    case LONG:{
      exp = jj_consume_token(LONG);
exp = null;
    {if ("" != null) return Constants.LONG_PRIM_TYPE;}
      break;
      }
    case FLOAT:{
      exp = jj_consume_token(FLOAT);
exp = null;
    {if ("" != null) return Constants.FLOAT_PRIM_TYPE;}
      break;
      }
    case DOUBLE:{
      exp = jj_consume_token(DOUBLE);
exp = null;
    {if ("" != null) return Constants.DOUBLE_PRIM_TYPE;}
      break;
      }
    case SYMBOL:{
      exp = jj_consume_token(SYMBOL);
exp = null;
    {if ("" != null) return Constants.OBJECT_TYPE;}
      break;
      }
    case STRING:{
      exp = jj_consume_token(STRING);
exp = null;
    {if ("" != null) return Constants.STRING_TYPE;}
      break;
      }
    case BOOLEAN:{
      exp = jj_consume_token(BOOLEAN);
exp = null;
    {if ("" != null) return Constants.BOOLEAN_PRIM_TYPE;}
      break;
      }
    case IDENTIFIER:{
      exp = jj_consume_token(IDENTIFIER);
if (exp.image.equals("DATE")) {
      {if ("" != null) return Constants.DATE_TYPE;}
    } else {
      {if ("" != null) return Constants.OBJECT_TYPE;}
    }
      break;
  ...
  final public Defrule ruleBody() throws ParseException {Token exp = null;
...
rule = new Defrule(exp.image);
  ...
  final public void ruleDeclaration(List<Object> list) throws ParseException {Token exp;
    jj_consume_token(LBRACE);
  ...
  final public void ruleProperty(List<Object> list) throws ParseException {Object exp = null;
  boolean tf = true;
  String ver = null;
...
RuleProperty tempprop = new RuleProperty(RuleProperty.TEMPORAL_ACTIVATION,temporal);
  ...
  final public Object salience() throws ParseException {Token exp = null;
  Object val = null;
    jj_consume_token(LBRACE);
...
exp = null;
  ...
  final public boolean autoFocus() throws ParseException {Token exp;
  boolean tf = false;
    jj_consume_token(LBRACE);
...
{if ("" != null) return tf;}
  ...
  final public String ruleVersion() throws ParseException {Token exp;
    jj_consume_token(LBRACE);
...
{if ("" != null) return exp.image;}
  ...
  final public boolean remember() throws ParseException {Token exp;
  boolean tf = false;
    jj_consume_token(LBRACE);
...
{if ("" != null) return tf;}
  ...
  final public String direction() throws ParseException {Token exp;
...
if (exp != null && exp.image.equals("backward")) {
      ...
      {if ("" != null) return defaultDir;}
    }
    throw new Error("Missing return statement in function");
}

  final public boolean noAgenda() throws ParseException {Token exp;
  boolean tf = false;
    jj_consume_token(LBRACE);
...
{if ("" != null) return tf;}
  ...
  final public String effectiveDate() throws ParseException {Token exp;
  Token date;
    jj_consume_token(LBRACE);
    exp = jj_consume_token(EFFECTIVE);
    date = jj_consume_token(STRING_LITERAL);
    jj_consume_token(RBRACE);
{if ("" != null) return date.image.substring(1,date.image.length() - 1);}
    throw new Error("Missing return statement in function");
}

  final public String expirationDate() throws ParseException {Token exp;
  Token date;
    jj_consume_token(LBRACE);
...
{if ("" != null) return date.image.substring(1,date.image.length() - 1);}
  ...
  final public boolean temporalAct() throws ParseException {Token exp;
  boolean tf = false;
    jj_consume_token(LBRACE);
...
// conditionalElement checks for object binding
  final public void conditionElement(List<Object> list) throws ParseException {Token exp;
...
// CEType checks the Conditional element to see if it's exist, not, test or plain
  final public void CEType(List<Object> list) throws ParseException {Token exp;
  // Token exp2;
  // Object etime;
  Object nested = null;
...
oc = new ObjectCondition();
  ...
  final public void nestedCE(AndCondition andcond) throws ParseException {Object nested = null;
...
TestCondition tc = new TestCondition();
  ...
  final public void temporalPattern(List<Object> list) throws ParseException {Token exp;
  // Object nested = null;
  List<Object> alpha = new ArrayList<Object>();
...
tmpc.setTemplateName(exp.image);
  ...
  final public void temporalDeclaration(TemporalCondition tmpc) throws ParseException {Token exp2;
  Object etime;
  Object itime = null;
  List<Object> params = new ArrayList<Object>();
    jj_consume_token(LBRACE);
...
tmpc.setVariableName(exp2.image.substring(1));
  ...
  final public void templatePatterns(List<Object> list) throws ParseException {Token exp = null;
    jj_consume_token(LBRACE);
    exp = jj_consume_token(IDENTIFIER);
...
exp = null;
  ...
  final public void propertyType(List<Object> list, Token identifier) throws ParseException {Token id = null;
  Object body = null;
  Token body2 = null;
  boolean bval = false;
...
// either a bind or typeExpr
  final public Object bindTypeExpr() throws ParseException {Token body = null;
  Object value = null;
    if (jj_2_38(2147483647)) {
      body = jj_consume_token(BIND);
{if ("" != null) return body.image;}
...
// need to enhance to handling bindings
  final public void andType(List<Object> list) throws ParseException {Token body = null;
  Object val = null;
  MultiValue mv = null;
  BoundConstraint bc;
...
if (val != null) {
  ...
  final public void orType(List<Object> list) throws ParseException {Token body = null;
  Object val = null;
  MultiValue mv = null;
...
if (val != null) {
  ...
  final public void predicateFunc(List<Object> list, Token identifier) throws ParseException {Token varname = null;
  String func = null;
  List<Object> params = new ArrayList<Object>();
  // Token bind = null;
  // Token val = null;
...
PredicateConstraint predc = new PredicateConstraint();
  ...
  final public String functionName() throws ParseException {Token fname = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
      fname = jj_consume_token(IDENTIFIER);
{if ("" != null) return fname.image;}
      break;
      }
    case PLUS:
    case MINUS:
...
{if ("" != null) return fname.image;}
  ...
  final public void arrow() throws ParseException {Token exp;
    exp = jj_consume_token(ARROW);
exp = null;
}

  final public void leftarrow() throws ParseException {Token exp;
...
exp = null;
  ...
  final public void ruleAction(List<Object> list) throws ParseException {Object exp;
    exp = expr();
list.add(exp);
}

  final public Defquery queryBody() throws ParseException {Token exp = null;
...
query = new Defquery(exp.image);
  ...
  final public GraphQuery graphQueryBody() throws ParseException {Token exp = null;
  Token querycomment = null;
  GraphQuery query;
  List<Object> variables = new ArrayList<Object>();
  List<Object> conditions = new ArrayList<Object>();
...
query = new GraphQuery(exp.image);
  ...
  final public void variables(List<Object> list) throws ParseException {Token exp = null;
    exp = getBindType();
list.add(exp.image);
}

  final public Defcube cubeExpr() throws ParseException {Defcube cube;
  Token cubename;
  List<Object> conditions = new ArrayList<Object>();
...
cube = new Defcube(engine);
  ...
  final public void cubeContents(List<Object> dimensions, List<Object> measures) throws ParseException {Token name;
  Token label;
  Token binding;
  ...
  private boolean jj_3_30()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x4000,0x6c201,0x200,0x201,0x5800,0x200,0x200,0x8800,0x200,0x6da00,0x6da00,0x68000,0x68000,0x81900000,0x6da00,0x0,0x6da00,0x6da00,0x6da00,0x81900000,0x6d800,0x68000,0x200,0x6d800,0x2d800,0x2d800,0x2d800,0x2d800,0x2d800,0x2d800,0x6d800,0x6d800,0x2d800,0x200,0x200000,0x8200,0x8200,0x0,0x1800,0x0,0x200,0x200,0x200,0x200,0x200,0x200,0x200,0x200,0x200,0x200,0x200,0x20000000,0x81900000,0x200,0x200,0x6da00,0x200,0x200,0x0,0x0,0x0,0x0,0x5800,0xd800,0x5800,0x6da00,0x0,0x0,0x200,0x200,0x68000,0x8200,0x8200,0x68000,0x8200,0x8200,0x200,0x0,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x482000fd,0x0,0x8000000,0x0,0x0,0x0,0x482000fd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x128400,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x18800800,0x482000fd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x6c00,0x6c00,0x0,0x0,0x7ff00000,0x6c00,0x7ff00000,0x6c00,0x6c00,0x6c00,0x7ff00000,0x6c00,0x0,0x0,0x6c00,0x0,0x0,0x0,0x0,0x0,0x0,0x6c00,0x6c00,0x0,0x0,0x68,0x0,0x0,0x20000,0x0,0x6c00,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x300,0x7ff00000,0x0,0x0,0x6c00,0x0,0x0,0x0,0x0,0x0,0x0,0xec00,0x0,0x0,0x6c00,0x3ff00000,0x3ff00000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x20,0x20,0x0,0x0,0x100,0x0,0x0,0x0,0x0,0x120,0x120,0x0,0x0,0x25,0x120,0x5,0x120,0x120,0x120,0x25,0x120,0x0,0x0,0x120,0x120,0x120,0x120,0x120,0x120,0x120,0x120,0x120,0x120,0x0,0x20,0x0,0x0,0x0,0x20,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x21,0x25,0x0,0x0,0x120,0x0,0x0,0x8,0x8,0x2,0x2,0x100,0x110,0x100,0x120,0x5,0x25,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20,};
	}
