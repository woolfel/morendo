...
(assert (guest (name "2") (sex "m") (hobby "1") ) )
...
(assert (guest (name "8") (sex "f") (hobby "2") ) )
(assert (guest (name "8") (sex "f") (hobby "1") ) )
...
(assert (guest (name "10") (sex "f") (hobby "3") ) )
(assert (guest (name "11") (sex "f") (hobby "3") ) )
(assert (guest (name "11") (sex "f") (hobby "1") ) )
...
(assert (guest (name "13") (sex "f") (hobby "3") ) )
(assert (guest (name "14") (sex "f") (hobby "3") ) )
(assert (guest (name "14") (sex "f") (hobby "1") ) )
(assert (guest (name "14") (sex "f") (hobby "2") ) )
(assert (guest (name "15") (sex "f") (hobby "3") ) )
(assert (guest (name "15") (sex "f") (hobby "2") ) )
(assert (guest (name "16") (sex "m") (hobby "3") ) )
(assert (guest (name "16") (sex "m") (hobby "1") ) )
(assert (last_seat (seat 16) ) )
(profile all)
(fire)
(print-profile)
